...
$query = 'SELECT * FROM bnc353_2.ProvinceAgeGroup AS Province';
        ...
        <div class="w3-content">
            <div>
              <div class="flex flex-row px-6 py-4 border-b border-gray-100 justify-between items-center">
                <h1 class="text-2xl m-0">Province</h1>
              </div>
                        ...
                        <? while($row = $statement->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="text-blue-500 underline" href="show.php?province=<?= $row["province"] ?>" >Show</a>
                                    <a class="text-blue-500 underline" href="edit.php?province=<?= $row["province"] ?>" >Edit</a>
                                </td>
                            </tr>
                        <? } ?>
                  </table>
