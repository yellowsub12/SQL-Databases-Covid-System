...
if(isset($_POST["firstName"]) 
    ...
    if($conn->query($query) == true){
        ...
        $query = "INSERT INTO bnc353_2.MedicareCard                                     
                            (medicardID,
                            doissue,
                            doexpire)
                            VALUES
                            ('$medicareID', '$doissue', '$doexpire')";

        if($conn->query($query) == true){   
            
            $query = "INSERT INTO bnc353_2.Registered                                     
                            (pID,
                            medicareID)
                            VALUES
                            ((
        ...
        <div class="w3-content">
            <div>
                ...
                <div class="container px-6 py-2">
                    <form action="./create-registered.php" method="post"  class="flex flex-col p-4 border border-gray-50 border-separate flex flex-col items-center w-full">
                        ...
                        <input type="number" name="medicareID" id="medicareID" class="border-2 border-gray-100 rounded-md px-2 py-2"> <br>
                        <label for="doissue"> Date of Issue </label><br>
                        <input type="date" name="doissue" id="doissue" class="border-2 border-gray-100 rounded-md px-2 py-2"> <br>
                        <label for="doexpire"> Date of Expire </label><br>
                        <input type="date" name="doexpire" id="doexpire" class="border-2 border-gray-100 rounded-md px-2 py-2"> <br>
