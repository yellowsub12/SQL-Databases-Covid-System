...
<script>
function myFunction() { 
	document.getElementById("susDate").style.display="none"; 
}
</script>
</head>
<body>
                ...
                <div class="container px-6 py-2">
                    <form action="./create.php" method="post" class="flex flex-col p-4 border border-gray-50 border-separate flex flex-col items-center w-full">
                        ...
                        <select name="status" id="status">
                            <option class = "myFunction()" value="SAFE">SAFE</option>
                            <option value="SUSPENDED">SUSPENDED</option>
                        </select><br>
                        <label for="appDate"> Approved Date </label>
                        <input type="date" name="approvedDate" value = "NULL" id="appDate" > <br>
